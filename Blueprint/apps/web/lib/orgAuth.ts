...
// ──────────────────────────────────────────────────────────────────────────────
// Scheduled interviews (Blueprint — optional report URL may point to InterviewX or elsewhere)
// ──────────────────────────────────────────────────────────────────────────────
...
export async function orgScheduledInterviewSummaryByEmployee(token: string) {
  return apiJson<Record<string, ScheduledInterviewEmployeeSummary>>(
    `/api/org-auth/scheduled-interviews/summary-by-employee`,
    { headers: { Authorization: `Bearer ${token}` } },
  );
}
